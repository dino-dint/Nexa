...
function Navbar() {
  ...
  return (
    <div>
      <nav className="bg-[rgb(223, 222, 222)] text-white px-3 py-3 relative z-40">
        <div className="flex justify-between items-center bg-zinc-950 h-14 px-3 rounded-3xl shadow-2xl">
          {/* 1. LEFT: Logo */}
          ...
          <div className="flex items-center space-x-4">
              <button className="hidden md:block p-2 text-gray-300  hover:text-white rounded-full hover:bg-zinc-800 transition-colors">
                <ShoppingCart size={22} />
              </button>
              <button type="button" className="hidden md:block p-2 text-zinc-800  rounded-full bg-cyan-300  hover:bg-cyan-200 transition-colors ">
                <UserRound size={22}/>
              </button>
            </div>
